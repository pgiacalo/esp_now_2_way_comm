...
// This is the receiver's MAC address. Replace with the actual MAC address of your other ESP32.
...
void app_main(void)
{
    ...
    ESP_LOGI(TAG, "Receiver MAC Address: "MACSTR, MAC2STR(receiver_mac));
